...
+tileDef  9, SNAKE_ADDR, 52, 53, 54, 55, SNAKE_PAL, 0
+tileDef  10, SNAKE_ADDR, 78, 79, 76, 77, SNAKE_PAL, TILE_FLIP_V
+tileDef  11, SNAKE_ADDR, 78, 79, 76, 77, SNAKE_PAL, TILE_FLIP_V
+tileDef  12, SNAKE_ADDR, 79, 78, 77, 76, SNAKE_PAL, TILE_FLIP_H | TILE_FLIP_V
+tileDef  13, SNAKE_ADDR, 79, 78, 77, 76, SNAKE_PAL, TILE_FLIP_H | TILE_FLIP_V
+tileDef  14, SNAKE_ADDR, 4, 5, 6, 7, SNAKE_PAL, 0
+tileDef  15, SNAKE_ADDR, 4, 5, 6, 7, SNAKE_PAL, 0
+tileDef  16, SNAKE_ADDR, 31, 30, 29, 28, SNAKE_PAL, TILE_FLIP_H | TILE_FLIP_V
+tileDef  17, SNAKE_ADDR, 31, 30, 29, 28, SNAKE_PAL, TILE_FLIP_H | TILE_FLIP_V
+tileDef  18, SNAKE_ADDR, 29, 28, 31, 30, SNAKE_PAL, TILE_FLIP_H
+tileDef  19, SNAKE_ADDR, 29, 28, 31, 30, SNAKE_PAL, TILE_FLIP_H
+tileDef  20, SNAKE_ADDR, 7, 6, 5, 4, SNAKE_PAL, TILE_FLIP_H | TILE_FLIP_V
+tileDef  21, SNAKE_ADDR, 7, 6, 5, 4, SNAKE_PAL, TILE_FLIP_H | TILE_FLIP_V
+tileDef  22, SNAKE_ADDR, 30, 31, 28, 29, SNAKE_PAL, TILE_FLIP_V
+tileDef  23, SNAKE_ADDR, 30, 31, 28, 29, SNAKE_PAL, TILE_FLIP_V
+tileDef  24, SNAKE_ADDR, 28, 29, 30, 31, SNAKE_PAL, 0
+tileDef  25, SNAKE_ADDR, 28, 29, 30, 31, SNAKE_PAL, 0
+tileDef  26, SNAKE_ADDR, 55, 54, 53, 52, SNAKE_PAL, TILE_FLIP_H | TILE_FLIP_V
+tileDef  27, SNAKE_ADDR, 55, 54, 53, 52, SNAKE_PAL, TILE_FLIP_H | TILE_FLIP_V
+tileDef  28, SNAKE_ADDR, 76, 77, 78, 79, SNAKE_PAL, 0
+tileDef  29, SNAKE_ADDR, 76, 77, 78, 79, SNAKE_PAL, 0
+tileDef  30, SNAKE_ADDR, 77, 76, 79, 78, SNAKE_PAL, TILE_FLIP_H
+tileDef  31, SNAKE_ADDR, 77, 76, 79, 78, SNAKE_PAL, TILE_FLIP_H
